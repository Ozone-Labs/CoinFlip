...
export default function CoinFlipping(props: { heads: boolean; end?: boolean }) {
    ...
    const handleFlip = () => {
        setTimeout(function timer() {
            ...
            if (props.heads) {
                setTimeout(function () {
                    setCoinAnimation('spin-head 0.1s infinite');
                }, 100);
            } else {
                setTimeout(function () {
                    setCoinAnimation('spin-tail 0.1s infinite');
                }, 100);
            }
        }, 100);
    };
    ...
    return (
        <div className="coin-flipping" style={{ animation: coinAnimation }}>
            ...
            <img src="/img/head.png" alt="heads" className="side-heads" width={'20%'} />
            {/* eslint-disable-next-line */}
            <img src="/img/tail.png" alt="tails" className="side-tails" width={'20%'} />
        </div>
    );
}
